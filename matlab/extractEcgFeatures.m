    ...
    if(~isempty(DWTsignalPeaks{i,1}) && ~isempty(DWTsignalPeaks{i,2}))
        ...
        if(length(DWTsignalPeaks{i,1}) >= 2 && length(DWTsignalPeaks{i,2}) >= 2)
            ...
            %if(strcmp(DWTsignalPeaks{i,3},'(VT') || strcmp(DWTsignalPeaks{i,3},'(B') || strcmp(DWTsignalPeaks{i,3},'(T') || strcmp(DWTsignalPeaks{i,3},'(N'))
             if(strcmp(DWTsignalPeaks{i,3},'(VT') || strcmp(DWTsignalPeaks{i,3},'(B') || strcmp(DWTsignalPeaks{i,3},'(T') || strcmp(DWTsignalPeaks{i,3},'(N') || strcmp(DWTsignalPeaks{i,3},'(AB') || strcmp(DWTsignalPeaks{i,3},'(AFIB') || strcmp(DWTsignalPeaks{i,3},'(AFL') || strcmp(DWTsignalPeaks{i,3},'(BII') || strcmp(DWTsignalPeaks{i,3},'(IVR') || strcmp(DWTsignalPeaks{i,3},'(NOD') || strcmp(DWTsignalPeaks{i,3},'(P') || strcmp(DWTsignalPeaks{i,3},'(PREX') || strcmp(DWTsignalPeaks{i,3},'(SBR') || strcmp(DWTsignalPeaks{i,3},'(SVTA') || strcmp(DWTsignalPeaks{i,3},'(VFL') || strcmp(DWTsignalPeaks{i,3},'(PREX'))
